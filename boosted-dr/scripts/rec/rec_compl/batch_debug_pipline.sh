...
TMP_RECORD="${EXPERIMENT_FORDER}/temp_record_train.log"

ARELS_PATH="/home/jupyter/jointly_rec_and_search/datasets/rec_search/rec_compl/arels.compl.train.tsv"
...
RANKING_PATH="${EXPERIMENT_FORDER}/${DATE}/runs/checkpoint_latest.train.run"
