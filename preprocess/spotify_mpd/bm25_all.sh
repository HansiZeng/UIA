...
# collection index
root_dir="/home/jupyter/unity_jointly_rec_and_search/datasets/spotify_mpd/processed"
mkdir -p "${root_dir}/track_v3/"
cp -u "${root_dir}/track.jsonl" "${root_dir}/track_v3/track.jsonl"

python -m pyserini.index -collection JsonCollection \
 -generator DefaultLuceneDocumentGenerator \
 -threads 1 -input "${root_dir}/track_v3/" \
