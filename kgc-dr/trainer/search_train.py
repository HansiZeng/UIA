...
from arguments import ModelArguments, SearchDataTrainArguments
...
def get_args():
    parser = HfArgumentParser((SearchDataTrainArguments, ModelArguments))
...
def train(args, model_args):
    ...
    # hard coding 
    assert args.train_q2p_path != "None"
    if args.q2p_path == "None":
        args.q2p_path = None
    if args.p2sp_path == "None":
        args.p2sp_path = None
    if args.p2cp_path == "None":
        args.p2cp_path = None
    ...
    if args.distributed:
        ...
        train_dataset = KGCTripleDataset.create_from_search_task_files(args.entites_path, tokenizer, 
                                                            max_head_text_len=args.max_head_text_len, max_tail_text_len=args.max_tail_text_len, 
                                                           train_q2p_path=args.train_q2p_path, q2p_path=args.q2p_path, 
                                                            p2sp_path=args.p2sp_path, p2cp_path=args.p2cp_path,
