...
def train(args, model_args):
    ...
    if args.distributed:
        ...
        train_dataset = KGCTripleDataset.create_from_six_triple_files(args.entites_path, tokenizer, 
                                                            max_head_text_len=args.max_head_text_len, max_tail_text_len=args.max_tail_text_len, 
                                                           a2cp_path=args.a2cp_path, a2sp_path=args.a2sp_path, 
                                                            q2a_path=args.q2a_path, c2cp_path=args.c2cp_path, 
                                                            c2sp_path=args.c2sp_path, q2c_path=args.q2c_path,
