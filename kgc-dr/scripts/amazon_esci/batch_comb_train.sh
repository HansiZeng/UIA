...
home_dir="/home/jupyter/unity_jointly_rec_and_search/datasets/amazon_esci_dataset/data/processed/public/task_1_query_product_ranking"
t_a2sp_path="${home_dir}/unified_train/a2sp.train.tsv"
t_a2cp_path="${home_dir}/unified_train/a2cp.train.tsv"
t_q2a_path="${home_dir}/unified_train/max2_qorient_q2p.train.tsv"
echo $t2_a2sp_path

entites_path="${home_dir}/all_entities.tsv"
experiment_folder="/home/jupyter/unity_jointly_rec_and_search/experiments/amazon_esci/"
