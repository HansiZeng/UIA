...
SIM_ANCHORS_PATH="${HOME_DIR}/unified_test/prefix_anchors.test.sim.small.tsv"
COMPL_ARELS_PATH="${HOME_DIR}/unified_test/arels.test.compl.tsv"
COMPL_ANCHORS_PATH="${HOME_DIR}/unified_test/prefix_anchors.test.compl.tsv"
QRELS_PATH="${HOME_DIR}/unified_test/qrels.test.tsv"
QUERIES_PATH="${HOME_DIR}/unified_test/prefix_queries.test.tsv"
