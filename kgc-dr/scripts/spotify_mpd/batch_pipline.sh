...
EXPERIMENT_FORDER="/home/jupyter/unity_jointly_rec_and_search/experiments/spotify_mpd"
...
QUERIES_PATH="${HOME_DIR}/unified_test/queries.test.small.tsv"

PASSAGE_PATH="${HOME_DIR}/all_tracks.tsv"
